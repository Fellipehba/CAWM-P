# -*- coding: utf-8 -*-
# VENDORIZADO de HydroBR (refactor) — get_data.py
# Origem: fork do HydroBR (Wallisson Carvalho), licença MIT.
# Mantido aqui porque o pacote PyPI 0.1.1 é incompatível com pandas moderno
# e a ANA legada; este parser deduplica datas e recupera a série completa.
# Nomes de método: list_prec(), list_flow(), prec(), flow(), stage().
import http.client  # usado em IncompleteRead
import calendar
import datetime
import json
import pandas as pd
